 ...
 */
class ConsultorRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(Consultor $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Consultor $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return Consultor[] Returns an array of Consultor objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?Consultor
    {
        return $this->createQueryBuilder('c')
            ->andWhere('c.exampleField = :val')
            ->setParameter('val', $value)
